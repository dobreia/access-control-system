...
<div class="container mx-auto p-6 bg-white rounded-lg shadow-md">
    <h1 class="text-2xl font-bold mb-4">Felhasználó módosítása</h1>
    ...
    <form method="POST" action="{{ route('users.update', $user->id) }}">
        ...
        <div class="mb-4">
            <label for="password" class="block text-sm font-medium text-gray-700">Jelszó (ha nem változik, hagyd
                üresen)</label>
